...
public class FloatingViewService extends Service {
    ...
    private static final int PERMISSION_REQUEST_MEDIA_PROJECTION = 1234;
    ...
    public void onCreate() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            // Sprawdź uprawnienie, jeśli nie jest już przyznane
        ...
        mFloatingView = LayoutInflater.from(this).inflate(R.layout.activity_service, null);
    ...
    private void startMyOwnForeground() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            String NOTIFICATION_CHANNEL_ID = "com.example.simpleapp.mediaProjection";
